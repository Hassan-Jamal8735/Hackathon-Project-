  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-7xl">
      ...
      <div className="mb-8">
        ...
        {selectedAnalysis && (
          <div className="bg-gradient-to-r from-blue-50 via-indigo-50 to-purple-50 border border-blue-200 rounded-2xl p-6 mb-6">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h2 className="text-xl font-bold text-gray-900">{selectedAnalysis.fileName}</h2>
                  <p className="text-gray-600">Analyzed {formatFirestoreDate(selectedAnalysis.createdAt)}</p>
                </div>
              </div>
            ...
            {(() => {
              ...
              return (
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                  ...
                  <div className="bg-white p-4 rounded-xl border border-gray-200">
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-sm font-medium text-gray-600">Analysis Result</span>
                      {story.label === 'CREDIBLE' && <CheckCircleIcon className="h-5 w-5 text-green-600" />}
                      {story.label === 'FAKE' && <XCircleIcon className="h-5 w-5 text-red-600" />}
                      {story.label === 'SUSPICIOUS' && <ExclamationTriangleIcon className="h-5 w-5 text-yellow-600" />}
                    </div>
                    <div className={`text-lg font-bold mb-1 ${
                      story.label === 'CREDIBLE' ? 'text-green-600' :
                      story.label === 'FAKE' ? 'text-red-600' :
                      'text-yellow-600'
                    }`}>
                      {story.label}
                    </div>
                  ...
                  <div className="bg-white p-4 rounded-xl border border-gray-200">
                    ...
                    <div className={`text-lg font-bold mb-1 ${
                      ...
                      story.riskLevel === 'MEDIUM' ? 'text-yellow-600' :
                      'text-green-600'
                    }`}>
                      {story.riskLevel}
                    </div>
      ...
      {analyses.length === 0 ? (
        <div className="bg-white rounded-lg shadow-md p-8 text-center">
          ...
          <h2 className="text-xl font-semibold text-gray-800 mb-2">No Analyses Yet</h2>
            ...
            {selectedAnalysis ? (
              <div className="space-y-6">
                ...
                {(() => {
                  ...
                  <div>
                          <h2 className="text-2xl font-bold text-green-800">AI Analysis Results</h2>
                          <p className="text-green-700">TruthShield's comprehensive content evaluation</p>
                        </div>
                      </div>
                        ...
                        <div className="bg-white p-6 rounded-xl border border-green-200">
                          ...
                          <div className="space-y-4">
                            <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                              <span className="font-medium text-gray-700">Content Classification</span>
                            ...
                            <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                              ...
                              <span className={`px-3 py-1 rounded-full text-sm font-semibold ${
                                story.riskLevel === 'HIGH' ? 'bg-red-100 text-red-800' :
                                story.riskLevel === 'MEDIUM' ? 'bg-yellow-100 text-yellow-800' :
                                'bg-green-100 text-green-800'
                              }`}>
                        ...
                        <div className="bg-white p-6 rounded-xl border border-green-200">
                          ...
                          <div className="space-y-4">
                            <div className="p-3 bg-blue-50 rounded-lg">
                              <div className="flex items-center justify-between mb-2">
                                <span className="text-sm font-medium text-blue-800">AI Processing Method</span>
                            ...
                            <div className="p-3 bg-purple-50 rounded-lg">
                              <div className="flex items-center justify-between mb-2">
                                <span className="text-sm font-medium text-purple-800">Analysis Duration</span>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  {selectedAnalysis.extractedText && (
                    <div className="bg-white rounded-xl border border-gray-200 shadow-sm">
                      <button
                        ...
                        className="w-full p-6 text-left flex items-center justify-between hover:bg-gray-50 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-300 focus:ring-opacity-50 rounded-lg"
                      >
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            <h3 className="text-lg font-semibold text-gray-800">Extracted Content</h3>
                            <p className="text-sm text-gray-600">Text extracted from your file</p>
                          </div>
                        </div>
                      ...
                      {expandedSections.extractedText && (
                        <div id="extracted-text-content" className="px-6 pb-6 border-t border-gray-100">
                  ...
                  <div className="bg-white rounded-xl border border-gray-200 shadow-sm">
                    <button
                      ...
                      className="w-full p-6 text-left flex items-center justify-between hover:bg-gray-50 transition-colors focus:outline-none focus:ring-2 focus:ring-green-300 focus:ring-opacity-50 rounded-lg"
                    >
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <h3 className="text-lg font-semibold text-gray-800">AI Analysis Evidence</h3>
                          <p className="text-sm text-gray-600">How TruthShield reached this conclusion</p>
                        </div>
                      </div>
                    ...
                    {expandedSections.aiReasoning && (
                      <div id="ai-reasoning-content" className="px-6 pb-6 border-t border-gray-100">
                        <div className="space-y-4">
                          ...
                          <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                            <div className="flex items-center space-x-2 mb-3">
                              ...
                              <span className="font-medium text-blue-800">AI Confidence Analysis</span>
                            </div>
                            <div className="grid grid-cols-2 gap-4">
                              <div>
                                <div className="text-sm text-blue-700 mb-1">Classification Confidence</div>
                              ...
                              <div>
                                <div className="text-sm text-blue-700 mb-1">Overall Credibility</div>
                                <div className="text-lg font-bold text-blue-900">
                          {(() => {
                  ...
                  {(() => {
                    ...
                    <button
                      ...
                      className="w-full p-6 text-left flex items-center justify-between hover:bg-gray-50 transition-colors focus:outline-none focus:ring-2 focus:ring-yellow-300 focus:ring-opacity-50 rounded-lg"
                    >
                          <div className="flex items-center space-x-3">
                            ...
                            <div>
                              <h3 className="text-lg font-semibold text-gray-800">Legal Guidance</h3>
                              <p className="text-sm text-gray-600">Recommended next steps</p>
                            </div>
                          </div>
                        ...
                        {expandedSections.legalGuidance && (
                          <div id="legal-guidance-content" className="px-6 pb-6 border-t border-gray-100">
                  ...
                  <div className="bg-white rounded-xl border border-gray-200 shadow-sm">
                    <button
                      ...
                      className="w-full p-6 text-left flex items-center justify-between hover:bg-gray-50 transition-colors focus:outline-none focus:ring-2 focus:ring-purple-300 focus:ring-opacity-50 rounded-lg"
                    >
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">What you should do next</p>
                        </div>
                      </div>
                    ...
                    {expandedSections.insights && (
                      <div id="insights-content" className="px-6 pb-6 border-t border-gray-100">
                        <div className="space-y-4">
                          {/* Next Steps */}
                          {selectedAnalysis.nextSteps && selectedAnalysis.nextSteps.length > 0 && (
                            <div className="bg-green-50 p-4 rounded-lg border border-green-200">
                              <div className="flex items-center space-x-2 mb-3">
                                ...
                                <span className="font-medium text-green-800">Recommended Next Steps</span>
                              </div>
                              <div className="space-y-2">
                          ...
                          <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                            <div className="flex items-center space-x-2 mb-3">
                              <DocumentTextIcon className="h-5 w-5 text-blue-600" />
                              <span className="font-medium text-blue-800">Export & Share</span>
                            </div>
                            <div className="grid grid-cols-2 gap-3">
                              <button className="bg-white border border-blue-300 text-blue-700 px-3 py-2 rounded-lg text-sm font-medium hover:bg-blue-50 transition-colors">
                                Download PDF Report
                              </button>
                              <button className="bg-white border border-blue-300 text-blue-700 px-3 py-2 rounded-lg text-sm font-medium hover:bg-blue-50 transition-colors">
                                Share Analysis
    ...
    {/* In Analysis.jsx - Enhanced AI Analysis section */}

{/* Extracted Text */}
{selectedAnalysis.extractedText && (
  <div>
    <h3 className="text-lg font-medium text-gray-900 mb-3">📄 Extracted Content</h3>
    <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
      <div className="mb-2 flex justify-between items-center">
        <span className="text-sm font-medium text-gray-700">Text Extraction Status:</span>
      ...
      <div className="mt-3">
        ...
        {selectedAnalysis.extractedText.length > 500 && (
          <button
            onClick={() => {
              // Show full text in modal or alert
          ...
          {/* Extracted Text */}
                      ...
                      <div className="bg-gray-50 p-4 rounded-lg">
                        ...
                        {selectedAnalysis.extractedText.length > 500 && (
                          <p className="text-sm text-gray-500 mt-2">
                            (Truncated - {selectedAnalysis.extractedText.length} characters total)
                          </p>
                        )}
                      </div>
                    </div>
                  ...
                  {(() => {
                    ...
                    if (guidance) {
                      return (
                        <div>
                          <h3 className="text-lg font-medium text-gray-900 mb-3">Legal Guidance</h3>
              ...
              <div className="bg-white rounded-lg shadow-md p-8 text-center">
                ...
                <h2 className="text-xl font-semibold text-gray-800 mb-2">Select an Analysis</h2>
